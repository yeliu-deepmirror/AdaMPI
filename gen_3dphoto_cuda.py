...
parser.add_argument('--img_path', type=str, default="debug/0919.png")
parser.add_argument('--disp_path', type=str, default=None)
parser.add_argument('--width', type=int, default=384)
parser.add_argument('--height', type=int, default=256)
# parser.add_argument('--save_path', type=str, default="debug/0919.mp4")
...
with torch.no_grad():
    ...
    # write_mpi_to_binary(image, pred_mpi_planes, pred_mpi_disp, opt.img_path + ".bin")
